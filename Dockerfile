...
# tools NEEDED
RUN apt-get install -yyq lsb-release wget gconf-service libatk-bridge2.0-0 libgconf-2-4 libgtk-3-0 libappindicator1 vim mc jq
...
RUN node_modules/screenshoteer/docker-entrypoint.sh
RUN cd -
